...
export interface IEntityWithServiceImplAndPaginationDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="jhipster180901App.entityWithServiceImplAndPagination.detail.title">
          ...
          <Button tag={Link} to="/entity/entity-with-service-impl-and-pagination" replace color="info">
          ...
          <Button
            tag={Link}
            to={`/entity/entity-with-service-impl-and-pagination/${entityWithServiceImplAndPaginationEntity.id}/edit`}
            replace
            color="primary"
          >
