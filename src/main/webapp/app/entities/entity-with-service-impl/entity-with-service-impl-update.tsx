...
export interface IEntityWithServiceImplUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export class EntityWithServiceImplUpdate extends React.Component<IEntityWithServiceImplUpdateProps, IEntityWithServiceImplUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity/entity-with-service-impl');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipster180901App.entityWithServiceImpl.home.createOrEditLabel">
              <Translate contentKey="jhipster180901App.entityWithServiceImpl.home.createOrEditLabel">
          ...
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : entityWithServiceImplEntity} onSubmit={this.saveEntity}>
                ...
                <Button tag={Link} id="cancel-save" to="/entity/entity-with-service-impl" replace color="info">
