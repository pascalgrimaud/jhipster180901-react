    ...
    return (
      <div>
        <h2 id="entity-with-pagination-heading">
          <Translate contentKey="jhipster180901App.entityWithPagination.home.title">Entity With Paginations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipster180901App.entityWithPagination.home.createLabel">Create new Entity With Pagination</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('nathan')}>
                  <Translate contentKey="jhipster180901App.entityWithPagination.nathan">Nathan</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
