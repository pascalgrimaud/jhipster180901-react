...
export type IEntityWithServiceClassPaginationAndDTOState = IPaginationBaseState;

export class EntityWithServiceClassPaginationAndDTO extends React.Component<
  IEntityWithServiceClassPaginationAndDTOProps,
  IEntityWithServiceClassPaginationAndDTOState
> {
  state: IEntityWithServiceClassPaginationAndDTOState = {
  ...
  render() {
    const { entityWithServiceClassPaginationAndDTOList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="entity-with-service-class-pagination-and-dto-heading">
          <Translate contentKey="jhipster180901App.entityWithServiceClassPaginationAndDTO.home.title">
            Entity With Service Class Pagination And DTOS
          </Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipster180901App.entityWithServiceClassPaginationAndDTO.home.createLabel">
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('lena')}>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      <Button tag={Link} to={`${match.url}/${entityWithServiceClassPaginationAndDTO.id}`} color="info" size="sm">
                        <FontAwesomeIcon icon="eye" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.view">View</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`${match.url}/${entityWithServiceClassPaginationAndDTO.id}/edit`} color="primary" size="sm">
                        <FontAwesomeIcon icon="pencil-alt" />{' '}
                        <span className="d-none d-md-inline">
                          <Translate contentKey="entity.action.edit">Edit</Translate>
                        </span>
                      </Button>
                      <Button tag={Link} to={`${match.url}/${entityWithServiceClassPaginationAndDTO.id}/delete`} color="danger" size="sm">
