...
export class EntityWithServiceClassPaginationAndDTODetail extends React.Component<IEntityWithServiceClassPaginationAndDTODetailProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="jhipster180901App.entityWithServiceClassPaginationAndDTO.detail.title">
              EntityWithServiceClassPaginationAndDTO
            </Translate>{' '}
            [<b>{entityWithServiceClassPaginationAndDTOEntity.id}</b>]
          </h2>
          ...
          <Button tag={Link} to="/entity/entity-with-service-class-pagination-and-dto" replace color="info">
          ...
          <Button
            tag={Link}
            to={`/entity/entity-with-service-class-pagination-and-dto/${entityWithServiceClassPaginationAndDTOEntity.id}/edit`}
            replace
            color="primary"
          >
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(EntityWithServiceClassPaginationAndDTODetail);
