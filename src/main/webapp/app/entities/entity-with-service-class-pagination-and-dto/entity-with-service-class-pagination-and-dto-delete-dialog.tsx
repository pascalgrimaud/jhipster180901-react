  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipster180901App.entityWithServiceClassPaginationAndDTO.delete.question">
          <Translate
            contentKey="jhipster180901App.entityWithServiceClassPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-entityWithServiceClassPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
