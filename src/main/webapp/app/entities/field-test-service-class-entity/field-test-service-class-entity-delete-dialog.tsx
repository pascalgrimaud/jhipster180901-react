...
export interface IFieldTestServiceClassEntityDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipster180901App.fieldTestServiceClassEntity.delete.question">
          <Translate
            contentKey="jhipster180901App.fieldTestServiceClassEntity.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-fieldTestServiceClassEntity" color="danger" onClick={this.confirmDelete}>
