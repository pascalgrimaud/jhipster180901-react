...
import { getEntities as getOperations } from 'app/entities/test-root/operation/operation.reducer';
...
export interface ILabelUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipster180901App.testRootLabel.home.createOrEditLabel">
              <Translate contentKey="jhipster180901App.testRootLabel.home.createOrEditLabel">Create or edit a Label</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : labelEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="labelNameLabel" for="labelName">
