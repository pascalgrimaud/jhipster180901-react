...
export type ILabelState = IPaginationBaseState;
...
export class Label extends React.Component<ILabelProps, ILabelState> {
  ...
  render() {
    const { labelList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="label-heading">
          <Translate contentKey="jhipster180901App.testRootLabel.home.title">Labels</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipster180901App.testRootLabel.home.createLabel">Create new Label</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('labelName')}>
                  <Translate contentKey="jhipster180901App.testRootLabel.labelName">Label Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
