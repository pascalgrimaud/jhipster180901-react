    ...
    return (
      <div>
        <h2 id="operation-heading">
          <Translate contentKey="jhipster180901App.testRootOperation.home.title">Operations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipster180901App.testRootOperation.home.createLabel">Create new Operation</Translate>
          </Link>
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('date')}>
                    <Translate contentKey="jhipster180901App.testRootOperation.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={this.sort('amount')}>
                    <Translate contentKey="jhipster180901App.testRootOperation.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                  ...
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      {operation.bankAccount ? (
                        <Link to={`bank-account-my-suffix/${operation.bankAccount.id}`}>{operation.bankAccount.name}</Link>
                      ) : (
                        ''
                      )}
                    </td>
