...
import { getEntities as getBankAccounts } from 'app/entities/test-root/bank-account-my-suffix/bank-account-my-suffix.reducer';
import { ILabel } from 'app/shared/model/test-root/label.model';
import { getEntities as getLabels } from 'app/entities/test-root/label/label.reducer';
...
export interface IOperationUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipster180901App.testRootOperation.home.createOrEditLabel">
              <Translate contentKey="jhipster180901App.testRootOperation.home.createOrEditLabel">Create or edit a Operation</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : operationEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="operation-bankAccount" type="select" className="form-control" name="bankAccount.id">
                    <option value="" key="0" />
                    {bankAccounts
