...
export interface IEntityWithServiceImplPaginationAndDTODetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="jhipster180901App.entityWithServiceImplPaginationAndDTO.detail.title">
          ...
          <Button tag={Link} to="/entity/entity-with-service-impl-pagination-and-dto" replace color="info">
          ...
          <Button
            tag={Link}
            to={`/entity/entity-with-service-impl-pagination-and-dto/${entityWithServiceImplPaginationAndDTOEntity.id}/edit`}
            replace
            color="primary"
          >
