  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipster180901App.entityWithServiceImplPaginationAndDTO.delete.question">
          <Translate
            contentKey="jhipster180901App.entityWithServiceImplPaginationAndDTO.delete.question"
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-entityWithServiceImplPaginationAndDTO" color="danger" onClick={this.confirmDelete}>
