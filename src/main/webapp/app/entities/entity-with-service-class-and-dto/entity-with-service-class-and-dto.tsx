    ...
    return (
      <div>
        <h2 id="entity-with-service-class-and-dto-heading">
          <Translate contentKey="jhipster180901App.entityWithServiceClassAndDTO.home.title">Entity With Service Class And DTOS</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipster180901App.entityWithServiceClassAndDTO.home.createLabel">
              Create new Entity With Service Class And DTO
            </Translate>
          </Link>
        </h2>
