...
export interface ITestManyToOneMySuffixUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
...
export class TestManyToOneMySuffixUpdate extends React.Component<ITestManyToOneMySuffixUpdateProps, ITestManyToOneMySuffixUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity/test-many-to-one-my-suffix');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipster180901App.testManyToOne.home.createOrEditLabel">
              <Translate contentKey="jhipster180901App.testManyToOne.home.createOrEditLabel">Create or edit a TestManyToOne</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : testManyToOneEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="test-many-to-one-my-suffix-testPager" type="select" className="form-control" name="testPager.id">
                    <option value="" key="0" />
                    {testPagers
                ...
                <Button tag={Link} id="cancel-save" to="/entity/test-many-to-one-my-suffix" replace color="info">
