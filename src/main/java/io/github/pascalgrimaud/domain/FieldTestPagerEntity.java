...
public class FieldTestPagerEntity implements Serializable {
    ...
    public String toString() {
        return "FieldTestPagerEntity{" +
            ...
            ", byteImageJadeContentType='" + getByteImageJadeContentType() + "'" +
            ", byteImageRequiredJade='" + getByteImageRequiredJade() + "'" +
            ", byteImageRequiredJadeContentType='" + getByteImageRequiredJadeContentType() + "'" +
            ", byteImageMinbytesJade='" + getByteImageMinbytesJade() + "'" +
            ", byteImageMinbytesJadeContentType='" + getByteImageMinbytesJadeContentType() + "'" +
            ", byteImageMaxbytesJade='" + getByteImageMaxbytesJade() + "'" +
            ", byteImageMaxbytesJadeContentType='" + getByteImageMaxbytesJadeContentType() + "'" +
            ", byteAnyJade='" + getByteAnyJade() + "'" +
            ", byteAnyJadeContentType='" + getByteAnyJadeContentType() + "'" +
            ", byteAnyRequiredJade='" + getByteAnyRequiredJade() + "'" +
            ", byteAnyRequiredJadeContentType='" + getByteAnyRequiredJadeContentType() + "'" +
            ", byteAnyMinbytesJade='" + getByteAnyMinbytesJade() + "'" +
            ", byteAnyMinbytesJadeContentType='" + getByteAnyMinbytesJadeContentType() + "'" +
            ", byteAnyMaxbytesJade='" + getByteAnyMaxbytesJade() + "'" +
            ", byteAnyMaxbytesJadeContentType='" + getByteAnyMaxbytesJadeContentType() + "'" +
