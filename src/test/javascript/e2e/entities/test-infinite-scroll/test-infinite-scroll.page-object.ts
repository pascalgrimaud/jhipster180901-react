...
export default class TestInfiniteScrollComponentsPage {
  createButton: ElementFinder = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('div table .btn-danger'));
  title: ElementFinder = element(by.id('test-infinite-scroll-heading'));
...
export class TestInfiniteScrollDeleteDialog {
  private dialogTitle: ElementFinder = element(by.id('jhipster180901App.testInfiniteScroll.delete.question'));
