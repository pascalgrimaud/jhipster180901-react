...
export default class TestServiceClassUpdatePage {
  pageTitle: ElementFinder = element(by.id('jhipster180901App.testServiceClass.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  userOneToManySelect: ElementFinder = element(by.css('select#test-service-class-userOneToMany'));
  userManyToManySelect: ElementFinder = element(by.css('select#test-service-class-userManyToMany'));
  userOneToOneSelect: ElementFinder = element(by.css('select#test-service-class-userOneToOne'));
