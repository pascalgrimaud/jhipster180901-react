...
export default class TestManyToOneUpdatePage {
  pageTitle: ElementFinder = element(by.id('jhipster180901App.testManyToOne.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  testEntitySelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testEntity'));
  testMapstructSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testMapstruct'));
  testServiceClassSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testServiceClass'));
  testServiceImplSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testServiceImpl'));
  testInfiniteScrollSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testInfiniteScroll'));
  testPagerSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testPager'));
  testPaginationSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testPagination'));
  testCustomTableNameSelect: ElementFinder = element(by.css('select#test-many-to-one-my-suffix-testCustomTableName'));
