...
export default class EntityWithServiceClassAndDTOComponentsPage {
  createButton: ElementFinder = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('div table .btn-danger'));
  title: ElementFinder = element(by.id('entity-with-service-class-and-dto-heading'));
...
export class EntityWithServiceClassAndDTODeleteDialog {
  private dialogTitle: ElementFinder = element(by.id('jhipster180901App.entityWithServiceClassAndDTO.delete.question'));
