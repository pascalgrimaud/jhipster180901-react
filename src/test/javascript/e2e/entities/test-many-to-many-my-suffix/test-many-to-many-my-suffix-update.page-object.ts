...
export default class TestManyToManyUpdatePage {
  pageTitle: ElementFinder = element(by.id('jhipster180901App.testManyToMany.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  testEntitySelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testEntity'));
  testMapstructSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testMapstruct'));
  testServiceClassSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testServiceClass'));
  testServiceImplSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testServiceImpl'));
  testInfiniteScrollSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testInfiniteScroll'));
  testPagerSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testPager'));
  testPaginationSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testPagination'));
  testCustomTableNameSelect: ElementFinder = element(by.css('select#test-many-to-many-my-suffix-testCustomTableName'));
