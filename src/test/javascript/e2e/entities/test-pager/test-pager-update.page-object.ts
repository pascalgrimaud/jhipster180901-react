...
export default class TestPagerUpdatePage {
  pageTitle: ElementFinder = element(by.id('jhipster180901App.testPager.home.createOrEditLabel'));
  saveButton: ElementFinder = element(by.id('save-entity'));
  cancelButton: ElementFinder = element(by.id('cancel-save'));
  userOneToManySelect: ElementFinder = element(by.css('select#test-pager-userOneToMany'));
  userManyToManySelect: ElementFinder = element(by.css('select#test-pager-userManyToMany'));
  userOneToOneSelect: ElementFinder = element(by.css('select#test-pager-userOneToOne'));
