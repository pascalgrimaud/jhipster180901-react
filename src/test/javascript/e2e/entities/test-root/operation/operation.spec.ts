...
describe('Operation e2e test', () => {
  ...
  it('should load create Operation page', async () => {
    ...
    expect(await operationUpdatePage.getPageTitle().getAttribute('id')).to.match(
      /jhipster180901App.testRootOperation.home.createOrEditLabel/
    );
  });
  ...
  it('should delete last Operation', async () => {
    ...
    expect(await operationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipster180901App.testRootOperation.delete.question/);
