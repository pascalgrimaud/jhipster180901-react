...
import io.github.pascalgrimaud.domain.TestPager;
import io.github.pascalgrimaud.repository.TestPagerRepository;
...
public class TestPagerResourceIntTest {
    ...
    public void setup() {
        ...
        final TestPagerResource testPagerResource = new TestPagerResource(testPagerRepository);
    ...
    public void getAllTestPagersWithEagerRelationshipsIsEnabled() throws Exception {
        TestPagerResource testPagerResource = new TestPagerResource(testPagerRepositoryMock);
