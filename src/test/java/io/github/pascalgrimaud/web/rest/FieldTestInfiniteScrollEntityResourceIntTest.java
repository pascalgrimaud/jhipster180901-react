...
public class FieldTestInfiniteScrollEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestInfiniteScrollEntityResource fieldTestInfiniteScrollEntityResource = new FieldTestInfiniteScrollEntityResource(fieldTestInfiniteScrollEntityRepository);
    ...
    public void updateFieldTestInfiniteScrollEntity() throws Exception {
        ...
        FieldTestInfiniteScrollEntity updatedFieldTestInfiniteScrollEntity = fieldTestInfiniteScrollEntityRepository.findById(fieldTestInfiniteScrollEntity.getId()).get();
