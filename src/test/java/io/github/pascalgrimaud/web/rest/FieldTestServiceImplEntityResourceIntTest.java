...
public class FieldTestServiceImplEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestServiceImplEntityResource fieldTestServiceImplEntityResource = new FieldTestServiceImplEntityResource(fieldTestServiceImplEntityService);
    ...
    public void updateFieldTestServiceImplEntity() throws Exception {
        ...
        FieldTestServiceImplEntity updatedFieldTestServiceImplEntity = fieldTestServiceImplEntityRepository.findById(fieldTestServiceImplEntity.getId()).get();
