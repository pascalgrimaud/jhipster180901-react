...
public class FieldTestPaginationEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestPaginationEntityResource fieldTestPaginationEntityResource = new FieldTestPaginationEntityResource(fieldTestPaginationEntityRepository);
    ...
    public void updateFieldTestPaginationEntity() throws Exception {
        ...
        FieldTestPaginationEntity updatedFieldTestPaginationEntity = fieldTestPaginationEntityRepository.findById(fieldTestPaginationEntity.getId()).get();
