...
import static io.github.pascalgrimaud.web.rest.TestUtil.sameInstant;
...
import io.github.pascalgrimaud.domain.enumeration.EnumFieldClass;
import io.github.pascalgrimaud.domain.enumeration.EnumRequiredFieldClass;
/**
...
public class FieldTestPagerEntityResourceIntTest {
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_REQUIRED_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] DEFAULT_BYTE_IMAGE_MINBYTES_JADE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_BYTE_IMAGE_MINBYTES_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MAXBYTES_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_REQUIRED_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] DEFAULT_BYTE_ANY_MINBYTES_JADE = TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_BYTE_ANY_MINBYTES_JADE = TestUtil.createByteArray(1, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MAXBYTES_JADE = TestUtil.createByteArray(1, "1");
    ...
    public void setup() {
        ...
        final FieldTestPagerEntityResource fieldTestPagerEntityResource = new FieldTestPagerEntityResource(fieldTestPagerEntityRepository);
    ...
    public void updateFieldTestPagerEntity() throws Exception {
        ...
        FieldTestPagerEntity updatedFieldTestPagerEntity = fieldTestPagerEntityRepository.findById(fieldTestPagerEntity.getId()).get();
