...
import io.github.pascalgrimaud.service.FieldTestMapstructEntityService;
...
public class FieldTestMapstructEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestMapstructEntityResource fieldTestMapstructEntityResource = new FieldTestMapstructEntityResource(fieldTestMapstructEntityService);
    ...
    public void updateFieldTestMapstructEntity() throws Exception {
        ...
        FieldTestMapstructEntity updatedFieldTestMapstructEntity = fieldTestMapstructEntityRepository.findById(fieldTestMapstructEntity.getId()).get();
