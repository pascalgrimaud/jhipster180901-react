...
import io.github.pascalgrimaud.repository.FieldTestEntityRepository;
...
public class FieldTestEntityResourceIntTest {
    ...
    public void setup() {
        ...
        final FieldTestEntityResource fieldTestEntityResource = new FieldTestEntityResource(fieldTestEntityRepository);
    ...
    @Test
    @Transactional
    public void checkInstantRequiredTomIsRequired() throws Exception {
        int databaseSizeBeforeTest = fieldTestEntityRepository.findAll().size();
        // set the field null
    ...
    public void getAllFieldTestEntities() throws Exception {
        ...
        restFieldTestEntityMockMvc.perform(get("/api/field-test-entities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].instantRequiredTom").value(hasItem(DEFAULT_INSTANT_REQUIRED_TOM.toString())))
    ...
    public void getFieldTestEntity() throws Exception {
        ...
        restFieldTestEntityMockMvc.perform(get("/api/field-test-entities/{id}", fieldTestEntity.getId()))
            ...
            .andExpect(jsonPath("$.instantRequiredTom").value(DEFAULT_INSTANT_REQUIRED_TOM.toString()))
    ...
    public void updateFieldTestEntity() throws Exception {
        ...
        FieldTestEntity updatedFieldTestEntity = fieldTestEntityRepository.findById(fieldTestEntity.getId()).get();
